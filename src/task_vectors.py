    ...
    def __init__(self, pretrained_checkpoint=None, finetuned_checkpoint=None, vector=None):
        ...
        if vector is not None:
            ...
            with torch.no_grad():
                ...
                pretrained_state_dict = torch.load(pretrained_checkpoint, pickle_module=pickle).state_dict()
                finetuned_state_dict = torch.load(finetuned_checkpoint, pickle_module=pickle).state_dict()
                self.vector = {}
