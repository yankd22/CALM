...
class EuroSAT(EuroSATBase):
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=0):
        super().__init__(preprocess, 'test', location, credible_samples, batch_size, num_workers)
...
class EuroSATVal(EuroSATBase):
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=0):
        super().__init__(preprocess, 'val', location, credible_samples, batch_size, num_workers)
