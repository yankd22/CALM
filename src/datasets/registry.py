...
def get_dataset(dataset_name, preprocess, location, credible_samples=None, batch_size=128, num_workers=0, val_fraction=0.1, max_val_samples=5000):
    # print(dataset_name, preprocess, location)
    ...
    dataset = dataset_class(
        preprocess, location=location, credible_samples = credible_samples, batch_size=batch_size, num_workers=num_workers
    )
    return dataset
